...
**CestaMoney** is a fork of [GoMoney](https://github.com/Rhymond/go-money) with extended operations. It provides the ability to work with [monetary value using a currency's smallest unit](https://martinfowler.com/eaaCatalog/money.html).
This package provides basic and precise Money operations such as rounding, splitting and allocating.  Monetary values should not be stored as floats due to compounding of small rounding differences.
...
``` bash
$ go get github.com/Gikabu/cesta-money
```
...
[![forthebadge](http://forthebadge.com/images/badges/built-with-love.svg)](https://github.com/Gikabu/cesta-money)
